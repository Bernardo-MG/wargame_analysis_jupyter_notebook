...
class TestZeroToTenAboveNotEqual(unittest.TestCase):
    ...
    def test_goal_6(self):
        ...
        chance = roll_chance(0, 10, 6, above=True, equal=False)

        self.assertEqual(Decimal('0.3636363636363636363636363636'), chance)

    def test_goal_7(self):

        chance = roll_chance(0, 10, 7, above=True, equal=False)
...
class TestOneToTenAboveNotEqual(unittest.TestCase):
    ...
    def test_goal_2(self):
        ...
        chance = roll_chance(1, 10, 2, above=True, equal=False)

        self.assertEqual(Decimal('0.8'), chance)

    def test_goal_3(self):

        chance = roll_chance(1, 10, 3, above=True, equal=False)
    ...
    def test_goal_6(self):
        ...
        chance = roll_chance(1, 10, 6, above=True, equal=False)

        self.assertEqual(Decimal('0.4'), chance)

    def test_goal_7(self):

        chance = roll_chance(1, 10, 7, above=True, equal=False)
...
class Test1d6Norm0AboveNotEqual(unittest.TestCase):
    ...
    def test_goal_0(self):
        ...
        chance = roll_chance(0, 5, 0, above=True, equal=False)

        self.assertEqual(Decimal('0.8333333333333333333333333333'), chance)

    def test_goal_1(self):

        chance = roll_chance(0, 5, 1, above=True, equal=False)

        self.assertEqual(Decimal('0.6666666666666666666666666667'), chance)

    def test_goal_2(self):

        chance = roll_chance(0, 5, 2, above=True, equal=False)

        self.assertEqual(Decimal('0.5'), chance)

    def test_goal_3(self):

        chance = roll_chance(0, 5, 3, above=True, equal=False)

        self.assertEqual(Decimal('0.3333333333333333333333333333'), chance)

    def test_goal_4(self):

        chance = roll_chance(0, 5, 4, above=True, equal=False)

        self.assertEqual(Decimal('0.1666666666666666666666666667'), chance)

    def test_goal_5(self):

        chance = roll_chance(0, 5, 5, above=True, equal=False)
