...
class TestOneToTenBelowNotEqual(unittest.TestCase):
    ...
    def test_goal_0(self):
        ...
        chance = roll_chance(1, 10, 0, above=False, equal=False)
    ...
    def test_goal_2(self):
        ...
        chance = roll_chance(1, 10, 2, above=False, equal=False)

        self.assertEqual(Decimal('0.1'), chance)

    def test_goal_3(self):

        chance = roll_chance(1, 10, 3, above=False, equal=False)

        self.assertEqual(Decimal('0.2'), chance)

    def test_goal_4(self):

        chance = roll_chance(1, 10, 4, above=False, equal=False)

        self.assertEqual(Decimal('0.3'), chance)

    def test_goal_5(self):

        chance = roll_chance(1, 10, 5, above=False, equal=False)

        self.assertEqual(Decimal('0.4'), chance)

    def test_goal_6(self):

        chance = roll_chance(1, 10, 6, above=False, equal=False)

        self.assertEqual(Decimal('0.5'), chance)

    def test_goal_7(self):

        chance = roll_chance(1, 10, 7, above=False, equal=False)

        self.assertEqual(Decimal('0.6'), chance)

    def test_goal_8(self):

        chance = roll_chance(1, 10, 8, above=False, equal=False)

        self.assertEqual(Decimal('0.7'), chance)

    def test_goal_9(self):

        chance = roll_chance(1, 10, 9, above=False, equal=False)

        self.assertEqual(Decimal('0.8'), chance)

    def test_goal_10(self):

        chance = roll_chance(1, 10, 10, above=False, equal=False)

        self.assertEqual(Decimal('0.9'), chance)

    def test_goal_above_max(self):

        chance = roll_chance(1, 10, 20, above=False, equal=False)
...
class Test1d6BelowNotEqual(unittest.TestCase):
    ...
    def test_no_goal(self):
        ...
        chance = roll_chance(1, 6, 0, above=False, equal=False)

        self.assertEqual(0, chance)

    def test_goal_above_max(self):

        chance = roll_chance(1, 6, 10, above=False, equal=False)

        self.assertEqual(1, chance)

    def test_goal_1(self):

        chance = roll_chance(1, 6, 1, above=False, equal=False)

        self.assertEqual(Decimal('0'), chance)

    def test_goal_2(self):

        chance = roll_chance(1, 6, 2, above=False, equal=False)

        self.assertEqual(Decimal('0.1666666666666666666666666667'), chance)

    def test_goal_3(self):

        chance = roll_chance(1, 6, 3, above=False, equal=False)

        self.assertEqual(Decimal('0.3333333333333333333333333333'), chance)

    def test_goal_4(self):

        chance = roll_chance(1, 6, 4, above=False, equal=False)

        self.assertEqual(Decimal('0.5'), chance)

    def test_goal_5(self):

        chance = roll_chance(1, 6, 5, above=False, equal=False)

        self.assertEqual(Decimal('0.6666666666666666666666666667'), chance)

    def test_goal_6(self):

        chance = roll_chance(1, 6, 6, above=False, equal=False)
...
class Test1d6Norm0BelowNotEqual(unittest.TestCase):
    ...
    def test_goal_above_max(self):
        ...
        chance = roll_chance(0, 5, 6, above=False, equal=False)

        self.assertEqual(1, chance)

    def test_goal_0(self):

        chance = roll_chance(0, 5, 0, above=False, equal=False)

        self.assertEqual(Decimal('0'), chance)

    def test_goal_1(self):

        chance = roll_chance(0, 5, 1, above=False, equal=False)

        self.assertEqual(Decimal('0.1666666666666666666666666667'), chance)

    def test_goal_2(self):

        chance = roll_chance(0, 5, 2, above=False, equal=False)

        self.assertEqual(Decimal('0.3333333333333333333333333333'), chance)

    def test_goal_3(self):

        chance = roll_chance(0, 5, 3, above=False, equal=False)

        self.assertEqual(Decimal('0.5'), chance)

    def test_goal_4(self):

        chance = roll_chance(0, 5, 4, above=False, equal=False)

        self.assertEqual(Decimal('0.6666666666666666666666666667'), chance)

    def test_goal_5(self):

        chance = roll_chance(0, 5, 5, above=False, equal=False)
